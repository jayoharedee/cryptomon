This is just me having fun with some [cryptocurrency](https://github.com/facebook/create-react-app) API's.

Some basic information about the project here.<br>
another link showing contributions [there](https://github.com/facebook/create-react-app/blob/master/packages/react-scripts/template/README.md).
